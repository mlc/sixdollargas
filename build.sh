...
#aws lambda update-function-configuration --function-name 'arn:aws:lambda:us-east-1:859317109141:function:sixdollargas-update' --runtime nodejs24.x
#aws lambda update-function-configuration --function-name 'arn:aws:lambda:us-east-1:859317109141:function:sixdollargas-stats' --runtime nodejs24.x
